...
@Component({selector: 'app-user-session', templateUrl: './session.component.html', styleUrls: ['./session.component.css']})
...
export class UserSessionComponent implements OnInit {
  ...
  constructor(public router: Router, public route: ActivatedRoute, public data: DataService, public http: HttpClient, public cookieService: CookieService, public appConfig: AppConfig, public modalService: ModalService, public focusService: FocusService, public snackBar: SnackBarService, public timezone: TimezoneService, public translate: TranslateService, public translation: TranslationService) {
    ...
    // Route Allowed?
    if (!rightLib.sufficientRights(this.data.userData.right, 'ActiveSession', 'Get List', 'own')) { this.router.navigate([`dashboard`]); }
  ...
  async update() {
    ...
    // Get Page Info
    dataLib.getPageInfo(this.appConfig.config, this.data.userData, 'model', this.objectDefinition, this.columns, this.pageInfo, this.resultInfo, null, this.sortingArray, this.filterArray, this.filterState, this.displayOptions, this.timezone, this.snackBar, this.cookieService, this.http);
