...
import * as crudLib from '../../../library/functions/crud';
...
@Component({selector: 'app-settings-crud', templateUrl: './crud.component.html', styleUrls: ['./crud.component.css']})
